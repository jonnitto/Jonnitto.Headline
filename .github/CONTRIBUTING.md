...
* Create an [issue](https://github.com/jonnitto/Jonnitto.Headline/issues) on GitHub, if you have found a bug
...
* Submit an [issue](https://github.com/jonnitto/Jonnitto.Headline/issues), assuming one does not already exist.
